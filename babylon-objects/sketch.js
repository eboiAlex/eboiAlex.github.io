      ...
      let human = {age: 20, height: 6, weight: 200, name: 'Bryan'};
      ...
      let model_settings = {
          ...
          file: "Georgia-Tech-Dragon/dragon.glb",
          color: {r:1, g:0, b:0},
          scale: 50,
    ...
    var camera = new BABYLON.FreeCamera("camera1", new BABYLON.Vector3(0, 4, -15), scene);
